...
def launch() -> None:
    """Start the FastAPI backend and the pure-stdlib UI (app2) as sibling processes, then block until interrupted."""
    env = os.environ.copy()
    ...
    print("Starting Doc Q&A Ingestion suite (app2)...")
    ...
    try:
        ...
        print(f" Launching UI (app2, stdlib http.server) on port {_UI_PORT}...")
